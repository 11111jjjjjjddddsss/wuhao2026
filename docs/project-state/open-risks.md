...
- 风险：这三份文案不是律师审定稿；公司主体、ICP备案、支付规则、礼品卡规则、账号注销、隐私同意弹窗、第三方服务 / SDK 清单、图片 OSS 保存周期和真实权限一旦变化，当前文案可能需要同步调整。当前 App 正文不暴露具体模型品牌，只按“第三方大模型和云服务”做必要告知；正式上线前仍需要按真实服务商补第三方服务清单。当前也尚未接首次启动隐私弹窗 / 勾选同意流程，上架或合规审核前可能需要补
