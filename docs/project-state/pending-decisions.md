...
- 待定原因：仍需结合真实发版、回滚、查日志、查库、客服回复、礼品卡和会员运营频率，决定哪些能力继续做网页后台，哪些沉淀成脚本 / CLI 封装；SLS 告警 / 仪表盘和数据库只读脚本仍待补齐
