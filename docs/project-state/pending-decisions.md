...
- 仍待决策：是否要把更细的地块 / 基地 / 作物茬口 / 棚室编号等沉淀进记忆文档“农业重点事件”或未来结构化字段；天气 API 暂不接入，只有明确需要实时天气 / 温湿度 / 降雨时再评估成本。定位当前只做到地区文本，不做轨迹、地图或地块坐标管理
