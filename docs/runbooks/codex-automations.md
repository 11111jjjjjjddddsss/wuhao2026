...
5. 需要发布时，查最近 7 天中国种植侧公开农业新闻，先拉出 6 到 10 个候选，再选三条分散地区 / 作物 / 主题且有生产或经营参考价值的内容；候选不够时才收窄，不要一开始只盯三夏、防灾、蔬菜价格这几类安全题。选题可覆盖栽培管理、植保病虫、苗情墒情、土壤墒情、节水灌溉、政策补贴、农资农机、种业种苗、绿色防控、技术培训、产地流通、批发价格、仓储保鲜、特色作物、地方农技推广和区域生产动态；最近 7 天已写过的同地区、同作物、同一事件尽量避开，最近 3 天已频繁出现的南方水稻排水防病、夏季蔬菜防灾减灾、黄淮海夏播或夏大豆、夏收天气、批发价格这类主题，只有出现明显新进展才继续写，否则优先换方向。摘要先说发生了什么，再说对农事安排、防灾减损、田间管理、农资选择、产地销售或政策申报有什么参考；每条摘要目标约 90-130 字，写成 2-3 个短段，每段 1 句，发布脚本参数可传带自然换行的字符串；不要写成一整块长段，也不要用项目符号、编号、Markdown 表格或额外小标题。语言自然、具体、正式，不写成文件通报，也不要过度口语化。放宽选题不等于写养殖水产、广告软文、旧闻、泛政策口号或没生产关系的宏观新闻；去重靠模型主动避开旧内容，不新增后端内容过滤。
