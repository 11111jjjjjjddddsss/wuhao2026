...
- Android 会员中心和设置页会员中心会在套餐区顶部提示“会员购买暂未开放；当前页面只展示套餐规则，不会发起扣费或变更权益”。
- 开通 Plus、开通 Pro、升级 Pro、购买加油包按钮当前都置灰显示“暂未开放”或当前套餐状态，不会给用户一种已经可交易的入口感。
...
- 管理后台把现有只读订单核查升级为正式订单查询、退款 / 对账状态、人工补偿和审计。
