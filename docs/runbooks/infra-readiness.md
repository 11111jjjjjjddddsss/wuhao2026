...
- 当前尚未购买 / 接入：SLS 节省计划 / 资源包、CDN / OSS 下行流量包。当前尚未完成：App 备案通过、公安备案、一键登录 / 验证码 / 主聊天 / 图片问诊真机回归、上线前 AccessKey 轮换；网站 ICP、`api.nongjiqiancha.cn` HTTPS、根域名官网 HTTPS 和 DashScope 主 / 副模型 Key 已于 2026-06-05 至 2026-06-06 通过 / 配置；默认 7 天 RDS 备份策略是否调整仍待确认
