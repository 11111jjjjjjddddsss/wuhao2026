...
2026-06-06 已部署到 ECS Nginx 静态站；2026-06-10 已重新部署并验证公安备案 footer、警徽图标和独立协议页面；2026-06-20 已补应用市场常用清单页并部署到生产静态站；2026-06-22 已将官网下载按钮切到当前正式 Android 包 `1.0.6(7)`，站点包 SHA-256 为 `591d602f06414e42e9b068e85d95627d6d754a7bcd21308c8475625b8a37018d`：
...
- 当前官网下载 APK：`https://download.nongjiqiancha.cn/android/releases/7/nongjiqiancha-1.0.6-v7-0cb814eb.apk`，SHA-256 `ee2957e3d313a034d68b1d67ff89d308d6301429b1ffaf2bfb7bf08f4c335aa0`，文件大小 `14,193,276` 字节；根域名和 `www` 域名加载的前端脚本均已确认包含该下载地址
