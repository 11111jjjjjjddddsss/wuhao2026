...
官网首版在 `site` 目录，使用 Vite 静态站实现。当前只做克制暗色一页展示：左侧品牌与产品主张“农业视觉智能，看懂作物现场”、右侧三项能力亮点“视觉语言问诊 / 农事上下文承接 / 稳妥判断路径”、安卓版下载按钮、服务边界和 footer 公司主体 / ICP；不做顶部导航、对话演示、管理后台，不保存后台 secret，不承载用户数据，也不把“联网校准”单独包装成公开核心卖点。
