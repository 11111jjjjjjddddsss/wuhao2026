...
2026-06-06 已部署到 ECS Nginx 静态站；2026-06-10 已重新部署并验证公安备案 footer、警徽图标和独立协议页面；2026-06-20 已补应用市场常用清单页并部署到生产静态站；2026-06-28 已将官网下载按钮切到当前正式 Android 包 `1.0.13(14)`，并把法律页版本同步为 `20260628`：
...
- 当前官网下载 APK：`https://download.nongjiqiancha.cn/android/releases/14/nongjiqiancha-1.0.13-v14-6f2c0ca6.apk`，SHA-256 `8781abe718da17ce70eae0fefcf96033c8717795b52e14bc3595e89f63f3fca6`，文件大小 `14,426,056` 字节；根域名和 `www` 域名加载的前端脚本均已确认包含该下载地址
