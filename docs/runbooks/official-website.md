...
2026-06-06 已部署到 ECS Nginx 静态站；2026-06-10 已重新部署并验证公安备案 footer、警徽图标和独立协议页面；2026-06-20 已补应用市场常用清单页并部署到生产静态站；2026-06-29 已将官网下载按钮切到当前正式 Android 包 `1.0.15(16)`，法律页版本仍为 `20260628`：
...
- 当前官网下载 APK：`https://download.nongjiqiancha.cn/android/releases/16/nongjiqiancha-1.0.15-v16-16dedafd.apk`，SHA-256 `5272a78d6a6dc31689e59af33f9095b1a1ccb85443f8182333c6fb8e62605276`，文件大小 `14,426,056` 字节；根域名和 `www` 域名加载的前端脚本均已确认包含该下载地址
