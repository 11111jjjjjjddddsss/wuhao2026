...
2026-06-06 已部署到 ECS Nginx 静态站；2026-06-10 已重新部署并验证公安备案 footer、警徽图标和独立协议页面；2026-06-20 已补应用市场常用清单页并部署到生产静态站；2026-06-23 已将官网下载按钮切到当前正式 Android 包 `1.0.8(9)`，站点包 SHA-256 为 `bd5b04f608504a683ebf4efab0660fe74bf420ea5d56afbc9afa06020817912e`：
...
- 当前官网下载 APK：`https://download.nongjiqiancha.cn/android/releases/9/nongjiqiancha-1.0.8-v9-e787a743.apk`，SHA-256 `924c4b05ce1a054c50ed90d46148c014648495d945e2d859176f70359302d1ff`，文件大小 `14,209,660` 字节；根域名和 `www` 域名加载的前端脚本均已确认包含该下载地址
