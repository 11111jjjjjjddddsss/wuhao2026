...
2026-06-06 已部署到 ECS Nginx 静态站；2026-06-10 已重新部署并验证公安备案 footer、警徽图标和独立协议页面；2026-06-20 已补应用市场常用清单页并部署到生产静态站；2026-06-30 已将官网下载按钮切到当前正式 Android 包 `1.0.17(18)`，法律页版本仍为 `20260628`：
...
- 当前官网下载 APK：`https://download.nongjiqiancha.cn/android/releases/18/nongjiqiancha-1.0.17-v18-4663b71a.apk`，SHA-256 `fb8639fd35e0ad79a7a09d07b1e2b16f006c089b998eb64c7d1e4fa66b1cdff3`，文件大小 `14,426,056` 字节；根域名和 `www` 域名加载的前端脚本均已确认包含该下载地址
