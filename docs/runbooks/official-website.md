...
2026-06-06 已部署到 ECS Nginx 静态站；2026-06-10 已重新部署并验证公安备案 footer、警徽图标和独立协议页面；2026-06-20 已补应用市场常用清单页并部署到生产静态站；2026-07-01 已将官网下载按钮切到当前正式 Android 包 `1.0.18(19)`，法律页版本仍为 `20260628`：
...
- 当前官网下载 APK：`https://download.nongjiqiancha.cn/android/releases/19/nongjiqiancha-1.0.18-v19-66bbebab.apk`，SHA-256 `31183d3fa1dd21a7f3f08730cfed9f54d463694e762f98d9fd0a2de5f758f81c`，文件大小 `14,426,056` 字节；根域名和 `www` 域名加载的前端脚本均已确认包含该下载地址
