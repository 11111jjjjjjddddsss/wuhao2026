...
第一版网页后台代码已落地并部署到 `https://admin.nongjiqiancha.cn/`；`api.nongjiqiancha.cn` HTTPS、根域名官网 HTTPS、管理后台 HTTPS、`download.nongjiqiancha.cn` OSS 低成本下载域名、SLS 最小日志集和 7 条 SLS AlertHub 最小告警已落地。本文记录当前真实环境和后续生产运维里 Codex 应该协助你的范围、入口和安全边界。
