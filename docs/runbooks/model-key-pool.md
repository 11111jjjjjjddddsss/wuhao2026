...
- 当前后端会对主对话 `qwen3.5-plus`、B/C 摘要 `qwen3.5-flash`、今日农情 `qwen3.5-plus` 共用同一个 Key 池。
...
- 前期可以先配两把独立账号 Key：`DASHSCOPE_API_KEY_1` 和 `DASHSCOPE_API_KEY_2`。
