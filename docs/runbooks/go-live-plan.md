...
2. 已完成：按 `ECS + RDS MySQL + OSS + 域名 / HTTPS` 落最小生产链的主要资源，其中 ECS / RDS / OSS 存储包已买，HTTPS、DNS、备案和后端部署尚未完成。
3. 下一步进入阿里云 ICP / App 备案流程，提交主体、域名、App 名称、图标、包名、签名、公钥、指纹、负责人和服务内容。
