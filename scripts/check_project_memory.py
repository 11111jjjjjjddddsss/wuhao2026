...
WATCHED_SCRIPT_EXACT = {
    ...
    "scripts/cloud-assistant-safe.ps1",
    "scripts/configure-ecs-daily-agri-job.ps1",
    "scripts/get-today-agri-manual-status.ps1",
    "scripts/harden-ecs-security.ps1",
    "scripts/probe-ecs-memory-document.ps1",
    "scripts/probe-ecs-today-agri.ps1",
    "scripts/publish-today-agri-manual.ps1",
    "scripts/setup-sls-alerts.ps1",
    "scripts/setup-sls-logging.ps1",
    "scripts/query-ecs-app-crashes.ps1",
    "scripts/query-ecs-logs.ps1",
    "scripts/query-sls-logs.ps1",
