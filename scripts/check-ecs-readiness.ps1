...
for key in \
  ...
  GPT_RELAY_PROVIDER_1_BASE_URL GPT_RELAY_PROVIDER_1_RESPONSES_URL GPT_RELAY_PROVIDER_1_API_KEY GPT_RELAY_PROVIDER_1_API_KEYS \
  GPT_RELAY_PROVIDER_2_BASE_URL GPT_RELAY_PROVIDER_2_RESPONSES_URL GPT_RELAY_PROVIDER_2_API_KEY GPT_RELAY_PROVIDER_2_API_KEYS \
