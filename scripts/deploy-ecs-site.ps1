...
foreach ($marker in @(
    ...
    'name="nongji-legal-version" content="20260628"',
...
$additionalLegalPageMarkers = @(
    @{
        ...
        Markers = @("nongji-page-third-party-sharing", 'name="nongji-legal-version" content="20260628"')
    },
    @{
        Path = "legal/personal-info-list/index.html"
        Markers = @("nongji-page-personal-info-list", 'name="nongji-legal-version" content="20260628"')
    },
    @{
        Path = "legal/app-permissions/index.html"
        Markers = @("nongji-page-app-permissions", 'name="nongji-legal-version" content="20260628"')
    },
    @{
        Path = "legal/risk-notice/index.html"
        Markers = @("nongji-page-risk-notice", 'name="nongji-legal-version" content="20260628"')
    }
)
...
if [ -f "`$cert_dir/fullchain.pem" ]; then
  ...
  expect_contains "site-legal-user-date" "name=\"nongji-legal-version\" content=\"20260628\"" -k --resolve "`$domain:443:127.0.0.1" "https://`$domain/legal/user-agreement/"
  ...
  expect_contains "site-legal-privacy-date" "name=\"nongji-legal-version\" content=\"20260628\"" -k --resolve "`$domain:443:127.0.0.1" "https://`$domain/legal/privacy-policy/"
  ...
  expect_contains "site-www-legal-user-date" "name=\"nongji-legal-version\" content=\"20260628\"" -k --resolve "`$www_domain:443:127.0.0.1" "https://`$www_domain/legal/user-agreement/"
  ...
  expect_contains "site-www-legal-privacy-date" "name=\"nongji-legal-version\" content=\"20260628\"" -k --resolve "`$www_domain:443:127.0.0.1" "https://`$www_domain/legal/privacy-policy/"
