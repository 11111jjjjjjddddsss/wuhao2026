...
Invoke-HttpProbe -Name "site_user_agreement" -Url "https://nongjiqiancha.cn/legal/user-agreement/" -ExpectedStatus @(200) -RequiredBodyMarkers @("nongji-page-user-agreement", 'name="nongji-legal-version" content="20260628"', 'name="nongji-legal-section" content="user-agreement-usage-norms"')
Invoke-HttpProbe -Name "site_privacy_policy" -Url "https://nongjiqiancha.cn/legal/privacy-policy/" -ExpectedStatus @(200) -RequiredBodyMarkers @("nongji-page-privacy-policy", 'name="nongji-legal-version" content="20260628"', 'name="nongji-privacy-section" content="long-term-memory"')
Invoke-HttpProbe -Name "site_third_party_sharing" -Url "https://nongjiqiancha.cn/legal/third-party-sharing/" -ExpectedStatus @(200) -RequiredBodyMarkers @("nongji-page-third-party-sharing", 'name="nongji-legal-version" content="20260628"')
Invoke-HttpProbe -Name "site_personal_info_list" -Url "https://nongjiqiancha.cn/legal/personal-info-list/" -ExpectedStatus @(200) -RequiredBodyMarkers @("nongji-page-personal-info-list", 'name="nongji-legal-version" content="20260628"')
Invoke-HttpProbe -Name "site_app_permissions" -Url "https://nongjiqiancha.cn/legal/app-permissions/" -ExpectedStatus @(200) -RequiredBodyMarkers @("nongji-page-app-permissions", 'name="nongji-legal-version" content="20260628"')
Invoke-HttpProbe -Name "site_risk_notice" -Url "https://nongjiqiancha.cn/legal/risk-notice/" -ExpectedStatus @(200) -RequiredBodyMarkers @("nongji-page-risk-notice", 'name="nongji-legal-version" content="20260628"')
...
Invoke-HttpProbe -Name "site_www_user_agreement" -Url "https://www.nongjiqiancha.cn/legal/user-agreement/" -ExpectedStatus @(200) -RequiredBodyMarkers @("nongji-page-user-agreement", 'name="nongji-legal-version" content="20260628"', 'name="nongji-legal-section" content="user-agreement-usage-norms"')
Invoke-HttpProbe -Name "site_www_privacy_policy" -Url "https://www.nongjiqiancha.cn/legal/privacy-policy/" -ExpectedStatus @(200) -RequiredBodyMarkers @("nongji-page-privacy-policy", 'name="nongji-legal-version" content="20260628"', 'name="nongji-privacy-section" content="long-term-memory"')
Invoke-HttpProbe -Name "site_www_third_party_sharing" -Url "https://www.nongjiqiancha.cn/legal/third-party-sharing/" -ExpectedStatus @(200) -RequiredBodyMarkers @("nongji-page-third-party-sharing", 'name="nongji-legal-version" content="20260628"')
Invoke-HttpProbe -Name "site_www_personal_info_list" -Url "https://www.nongjiqiancha.cn/legal/personal-info-list/" -ExpectedStatus @(200) -RequiredBodyMarkers @("nongji-page-personal-info-list", 'name="nongji-legal-version" content="20260628"')
Invoke-HttpProbe -Name "site_www_app_permissions" -Url "https://www.nongjiqiancha.cn/legal/app-permissions/" -ExpectedStatus @(200) -RequiredBodyMarkers @("nongji-page-app-permissions", 'name="nongji-legal-version" content="20260628"')
Invoke-HttpProbe -Name "site_www_risk_notice" -Url "https://www.nongjiqiancha.cn/legal/risk-notice/" -ExpectedStatus @(200) -RequiredBodyMarkers @("nongji-page-risk-notice", 'name="nongji-legal-version" content="20260628"')
