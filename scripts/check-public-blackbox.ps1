...
Invoke-HttpProbe -Name "site_https_root" -Url "https://nongjiqiancha.cn/" -ExpectedStatus @(200)
Invoke-HttpProbe -Name "site_www_https_root" -Url "https://www.nongjiqiancha.cn/" -ExpectedStatus @(200)
