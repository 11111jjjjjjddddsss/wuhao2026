...
- 2026-06-01 已将后端 commit `9be4cc76` 部署到 ECS，生产健康检查为 `ok=true / auth_strict=true / bailian=missing_key / dypns=missing_key / dypns_fusion=missing_config / dypns_sms=missing_config / dev_order_endpoints=false / redis=ok / upload_storage=oss`
