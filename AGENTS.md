...
- 2026-06-01 后端最新已部署到 ECS，当前部署提交为 `ff4f15c2`；阿里云融合认证 Android 方案、DYPNS AccessKey / Secret、`DYPNS_FUSION_SCHEME_CODE`、包名和签名、短信资质 / 签名 / 验证码模板、Redis、OSS 上传后端均已写入生产环境并通过健康检查。当前仍缺 DashScope 模型 Key、HTTPS / 备案、一键登录真机回归和上线前 AccessKey 轮换
