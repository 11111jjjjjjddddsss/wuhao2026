...
- 今日农情提示词版本当前为 `2026-06-12-v67`：检索阶段最大限度全网宽搜、不锁固定网站，质量优先级是“近 7 天真实具体材料 > 种植侧大类正确 > 信息对生产或流通有直接意义 > 内容尽量不重复 > 手机卡片好读”。提示词必须让模型输出 3 条，这是唯一硬数量要求；如果材料不够就扩大检索词继续找真实种植侧材料，不把数量降到 2 条，也不为了凑数去选养殖、水产、旧闻、广告软文、弱材料或泛泛动态。大类边界要清楚：本卡只取种植侧，生产动态、农事指导、病虫测报、苗情墒情、专项监测、农业气象、灾害预警、春播夏管秋收进度、天气农时、价格流通、政策补贴、平台建设、技术方案、技术推广等都可以选，但这些只是选题方向和检索路标，不是硬配额；必要时可改搜病虫害测报、农作物病虫预报、农业旱涝监测、土壤水分、农事建议、农业气象周报、单品价格或产区行情等更像农情的材料。养殖、水产、畜牧、动物疫病、生猪、猪肉、猪价、家禽、禽蛋、鸡肉、鸡蛋、牛羊、奶业、奶价、饲料、饲用原料、兽药、渔业、鱼虾和动物类价格等不要。即使来源把这类内容说成影响农户收入、消费预期、农资购买力或农业整体行情，也不作为本卡条目；不要用“间接影响种植户”作为保留理由。标题约 10-14 个中文字符、最多不超过 16 个中文字符；摘要目标约 90-130 个中文字符、至少两句，宁可写到 100 字左右也不要收成 70 多字的薄摘要。调研、会议、平台上线和成果展示类材料必须有具体种植事实和直接影响，否则换更具体材料；标题不要用“调研推动”“场景上新”“即将投用”“成果展示”这类过程词掩盖空泛材料。必须是自然资讯口吻，禁止“值得看 / 参考意义 / 对农户有用 / 根据搜索结果 / 检索显示 / 可关注”等元表达、推荐理由和标题党话术；这仍是提示词层面的方向控制，不增加后端内容过滤或字数拦截；养殖水产和动物类价格边界继续靠提示词、探针和后台复核观察控制
