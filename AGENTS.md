...
- 今日农情提示词版本当前为 `2026-06-11-v50`：检索阶段最大限度全网宽搜、不锁固定网站，质量优先级是“近 7 天真实具体材料 > 种植侧大类正确 > 信息对生产或流通有直接意义 > 三条尽量不雷同 > 手机卡片好读”。大类边界要清楚：本卡只取种植侧，覆盖粮油、蔬菜、果品、棉花、茶桑、种子种业、植保病虫草害、农药肥料农资、农机农时、农田水利、明确影响作物生产的农业气象 / 灾害预警 / 田管措施、种植侧产地 / 批发 / 农资价格、补贴保险和技术推广；养殖、水产、畜牧、动物疫病、生猪、猪肉、猪价、家禽、禽蛋、牛羊、奶业、饲料、饲用原料、兽药、渔业、鱼虾等不要。即使来源把猪肉、生猪、禽蛋、水产、饲料说成影响农户收入、消费预期、农资购买力或农业整体行情，也不作为本卡条目；不要用“间接影响种植户”作为保留理由。小类不要卡死：天气、农时进度、价格、政策、补贴、平台建设、技术推广都可以选，只要近 7 天、真实具体、明确服务种植生产或种植侧流通即可；同等质量下尽量分散主题，如果某类材料明显更真实、更新、更有直接影响，可以出现两条，但不能把同一事件、同一材料或同一组综合行情拆条。标题约 10-14 个中文字符、最多不超过 16 个中文字符、一行读完；摘要约 80-110 个中文字符、手机卡片约 3-4 行体量；`source_name` 只写机构 / 媒体 / 站点短名，不写文章标题、网页标题、频道页、站点口号、URL、“搜索结果”或“网络来源”；`published_date` 能确认才写，不能确认就写空字符串，不因日期字段、来源层级或标题不完美而只给 2 条。提示词继续压住旧闻、过期材料、综合指数 / 综合行情凑数、养殖 / 饲料行情混入、广告软文、谣言假新闻、空泛会议 / 成果 / AI 工具新闻、标题党和模型编造数字；数字、指数、价格、比例、面积、补贴金额和进度必须来自来源材料，不确定就省略，尤其 7.82% 不能写成“近八成”。必须是自然资讯口吻，禁止“值得看 / 参考意义 / 对农户有用 / 根据搜索结果 / 检索显示 / 可关注”等元表达、推荐理由和标题党话术
