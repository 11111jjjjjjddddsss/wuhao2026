...
func TestLegacyMergePreservesSessionABMemoryWhenTargetExists(t *testing.T) {
	...
	for _, want := range []string{
		...
		"target.pending_memory_jobs_json",
		"source.pending_memory_jobs_json",
		"json_merge_preserve(target.pending_memory_jobs_json, source.pending_memory_jobs_json)",
