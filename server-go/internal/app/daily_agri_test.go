...
func TestBuildDailyAgriMessagesControlsQualityByPrompt(t *testing.T) {
	...
	for _, want := range []string{
		...
		"新品种 / 新技术 / 农机农资",
		"可复制的地方田管案例",
		"会议、调研、发布会、意见、通知、推进工作、总体适宜、稳中向好、加强指导这类行政材料本身不优先",
		"哪个地区、哪类作物、哪类人现在该注意什么或能用什么",
		"不要用“总体适宜”“创新高”“加强推进”这类泛标题遮盖空内容",
		"风险 / 窗口 / 措施 / 价格 / 补贴 / 进度 / 技术点",
		"搜不到具体要素时换新闻",
		"不要把官方句子换个说法",
		"选题以种植方面的新闻为主",
		"不限制具体作物",
		"大田作物、经济作物、设施农业、果树、蔬菜、茶叶、特色作物等都可以",
		"不要总集中在水稻、蔬菜、夏收夏种和天气提醒",
		"先说清楚发生了什么",
		"农资选择、产地销售或政策申报",
		"语言自然、具体、正式",
		"更优先选择对生产或经营有实际参考价值的内容",
		"栽培管理、植保病虫、种子种苗、农资农机、技术推广、土壤墒情、节水灌溉、产地流通 / 价格、仓储保鲜、政策补贴、地方农技推广等真实进展",
		"天气、气象、防灾或抢收可以作为其中一个角度",
		"对农事安排、防灾减损或田间管理有什么影响",
		"只取种植侧",
		"养殖、水产、畜牧",
...
func TestBuildDailyAgriRetryPromptTargetsModelNotParser(t *testing.T) {
	...
	for _, want := range []string{
		"补救生成",
		"换地区、作物、信息源和选题钩子继续找近 7 天真实种植侧公开材料",
		"仍必须 3 条",
		"优先找有生产价值、经营参考或技术含量的种植新闻",
		"不要继续围着水稻、蔬菜、夏收夏种、天气提醒或行政通知打转",
		"除非有明显新进展和可用参考",
		"不用天气预报、养殖水产、旧闻、软文、空泛政务稿或重复事件凑数",
	} {
