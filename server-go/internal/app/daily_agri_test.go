...
func TestBuildDailyAgriMessagesControlsQualityByPrompt(t *testing.T) {
	...
	for _, want := range []string{
		...
		"鸡肉、鸡蛋、牛羊、奶业、奶价",
		"如果材料主体是养殖、水产、饲料、饲用原料或养殖类价格，就换成种植侧材料",
		"不要用“间接影响种植户”作为保留理由",
		"大类边界要清楚，小类不要抠太细",
		...
		"综合农业材料只摘种植侧事实",
		"如果材料主体是养殖、水产、饲料、饲用原料或养殖类价格，就整条换掉",
		"不要只把摘要改成“间接影响种植”",
		...
		"一般不要明显低于 90 个中文字符",
		"通常至少两句",
		"再补充直接农业影响、农时窗口、风险点、供应变化、农资/流通影响或基层可留意的事项",
		"避免写成一句很薄的通知",
		"不要为了凑字堆套话",
		...
		"不自行换算、夸大或改口径",
		"source_name 优先写机构、媒体或站点短名",
		"避免写文章标题、网页标题、频道页、站点口号",
		"拿不准时按网页发布者、站点名或机构名写",
